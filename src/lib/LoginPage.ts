...
export class LoginPage extends Page {
  ...
  constructor(app: MyApp) {
    super("login", app);
    this.loginChatBtn = document.getElementById(
      "loginChatBtn"
    ) as HTMLButtonElement;
    this.accountSignup = document.getElementById(
      "accountSignup"
    ) as HTMLButtonElement;
    this.googleLogin = document.getElementById(
      "googleLogin"
    ) as HTMLButtonElement;
    this.emailLogin = document.getElementById("emailLogin") as HTMLInputElement;
    this.passwordLogin = document.getElementById(
      "passwordLogin"
    ) as HTMLInputElement;
  }
